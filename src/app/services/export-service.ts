...
/* { ListViewExpandableService } from './list-view-expandable-service';
...
export class ExportService{
   ...
   /* getNewPassword() {
    ...
    getAlert() {
        let service = new AlertService(null, null);
        return {
            'layout1': service.getDataForLayout1(),
            'layout2': service.getDataForLayout2(),
    ...
    getLogin() {
        let service = new LoginService(null);
        return {
            'layout1': service.getDataForLayout1(),
            'layout2': service.getDataForLayout2(),
        }
    ...
    getRegister() {
        let service = new RegisterService(null);
        return {
            'layout1': service.getDataForLayout1(),
            'layout2': service.getDataForLayout2(),
        }
   ...
   /* getListViewExpandable() {
    ...
    getForm() {
        let service = new FormService(null, null);
        return {
            'layout1': service.getDataForLayout1(),
            'layout2': service.getDataForLayout2(),
            'layout3': service.getDataForLayout3(),
   ...
   /* getProfile() {
    ...
    getMenu() {
        let service = new MenuService(null);
        return service.getDataForTheme(null)
    }
    ...
    getAnimation() {
        let service = new AnimationService(null);
        return {
            'layout1': service.getDataForLayout1(),
            'layout2': service.getDataForLayout2(),
            'layout3': service.getDataForLayout3(),
